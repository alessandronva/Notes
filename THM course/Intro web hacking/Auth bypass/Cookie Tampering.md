...
```shell-session
user@tryhackme$ curl http://10.10.3.56/cookie-test
```
...
```shell-session
user@tryhackme$ curl -H "Cookie: logged_in=true; admin=false" http://10.10.3.56/cookie-test
```
...
```shell-session
user@tryhackme$ curl -H "Cookie: logged_in=true; admin=true" http://10.10.3.56/cookie-test
```
