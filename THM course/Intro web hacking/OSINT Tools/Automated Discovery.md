...
```shell-session
user@machine$ ffuf -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -u http://10.10.63.253/FUZZ
```
...
```shell-session
user@machine$ dirb http://10.10.63.253/ /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
```
...
```shell-session
user@machine$ gobuster dir --url http://10.10.63.253/ -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
```
